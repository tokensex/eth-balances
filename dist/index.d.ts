 ...
 */
export declare function balancesByContract(metaDataByContract: MetaByContract, balanceDataByContract: Record<string, ReturnData>): Record<string, TokenInfo>;
/**
 ...
 */
export declare function getTokenBalances({ addressOrName, contractAddresses, provider, chunkSize, multicallCustomContractAddress, }: BalanceRequest & {
    multicallCustomContractAddress?: ContractAddress;
    chunkSize?: number;
